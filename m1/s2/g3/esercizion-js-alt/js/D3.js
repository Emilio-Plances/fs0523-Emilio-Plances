...
starWarsCharacters.forEach(function(element){
...
starWarsCharacters.forEach(function(element){
  switch(element.eye_color){
    case 'blue':
      eyeColor.blue.push(element.name);
      break;
    case 'yellow':
      eyeColor.yellow.push(element.name);
      break;
    case 'brown':
      eyeColor.brown.push(element.name);
      break;     
    case 'red':
